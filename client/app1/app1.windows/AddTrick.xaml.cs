...
namespace App1
{
    ...
    /// </summary>
    public sealed partial class AddTrick : Page, IActionStarter
    {
            ...
            TrickService.Make(
                delegate(bool success)
                {
                    Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, () =>
                    {
                        ...
                        {
                            MessageDialog dialog = new MessageDialog("Het opslaan van de trick is mislukt");
                            dialog.ShowAsync();
                        }
                        this.Frame.GoBack();
                    });
